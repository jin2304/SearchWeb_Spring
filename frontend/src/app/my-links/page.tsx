...
export default function MyLinksPage() {
  ...
  const shouldFetchBookmarks = (searchScope === 'all' && isSearching) || savedTodayFilter;
  ...
  const isShowingFiltered = isSearching || savedTodayFilter;
        ...
        <div className="mb-5 flex flex-col items-start bg-transparent">
          ...
          <div className="relative w-full max-w-md mb-3">
            <div className="group bg-white dark:bg-gray-900 rounded-full flex items-center p-1 shadow-sm border border-gray-200 dark:border-gray-700 hover:border-gray-300 dark:hover:border-gray-600 transition-all duration-300">
              ...
              {/* Search Scope Toggle (Folders / All) */}
              <div className="flex items-center bg-gray-100/80 dark:bg-gray-800/80 p-0.5 rounded-lg mr-1 ml-1 shrink-0 border border-gray-200/50 dark:border-gray-700/50">
                <button
              ...
              {searchQuery && (
                <button 
                  ...
                  className="flex items-center justify-center h-7 w-7 text-gray-400 hover:text-gray-600 dark:text-gray-500 dark:hover:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-full transition-colors mr-0.5"
                >
          ...
          <div>
            <div className="mb-4 ml-1">
              <h2 className="text-xs font-bold text-gray-800 dark:text-gray-100 flex items-center gap-2">
                ...
                {savedTodayFilter ? 'Saved Today' : 'Search Results'}: {searchResultFolderCount} folders found
              </h2>
            </div>
