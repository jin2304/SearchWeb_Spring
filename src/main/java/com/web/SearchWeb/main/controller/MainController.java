 ...
 *
 *  코드 설명:
 *   -/main :Searchweb 서비스에 대해 소개하는 페이지.
 *   -/mainList :MainController는 카테로리별로 웹사이트 목록을 보여주거나, 검색을 통해 특정 웹사이트 검색이 가능하다.
 *
 *
 *  코드 주요 기능:
 *   -/main :Searchweb 서비스 소개 페이지
 *   -/mainList :카테고리별 웹사이트 목록 조회, 검색어 기반으로 웹사이트 목록 조회
 *
 *
 *  코드 작성일:
